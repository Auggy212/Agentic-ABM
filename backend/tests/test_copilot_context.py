"""
Tests for the RAG Copilot context loader.

We do NOT call the live Anthropic API in tests — the Anthropic client is
monkey-patched so assertions cover page-context construction and error paths.
