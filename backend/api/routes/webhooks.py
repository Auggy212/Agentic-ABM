...
def verify_phantombuster(signature_header: str | None) -> bool:
    """PhantomBuster does not sign payloads on the free tier â€” it sends a shared
...
# session. Per master prompt Â§7: heavy work goes off the request thread.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# PhantomBuster â€” LINKEDIN_DM / LINKEDIN_CONNECTION
# ---------------------------------------------------------------------------
...
async def twilio_webhook(
    ...
    # Twilio signs the *full* URL Twilio called (including scheme + host) â€” use
