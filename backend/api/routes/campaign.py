...
def trigger_run(
    ...
    # its own CampaignRunRecord â€” operators poll by client_id+latest.
...
# ---------------------------------------------------------------------------
# Halt + resume (operator + global). Master prompt Â§3: RESUME friction is
# the safety mechanism â€” the body confirmation must equal exactly 'RESUME'.
# ---------------------------------------------------------------------------
