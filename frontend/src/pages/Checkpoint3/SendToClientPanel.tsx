...
export default function SendToClientPanel({
  ...
  return (
    <div className="card card-pad" style={{ borderRadius: 8, display: "grid", gap: 14 }}>
      <div>
        <div className="section-eyebrow">Step 3 — Client review</div>
        <h3 style={{ margin: "4px 0 0", fontFamily: "var(--font-display)", fontSize: 24, fontWeight: 400 }}>Send sample messages to the client</h3>
        <div style={{ fontSize: 13, color: "var(--text-2)", marginTop: 6, lineHeight: 1.5, maxWidth: 560 }}>
          Pick 5 representative messages and email them to the client. They'll see a private review page where they can leave comments and approve. You can't approve CP3 until the client completes their review.
        </div>
      </div>
